...
public class Constant {
	...
	public static final String excelutility_excelfilepath = System.getProperty("user.dir")
			+ "\\src\\test\\resources\\TestData\\TestData.xlsx";
	public static final String ImagePath1 = System.getProperty("user.dir")
			+ "\\src\\test\\resources\\images\\FASHION.jpg";
	public static final String ImagePath2 = System.getProperty("user.dir")
			+ "\\src\\test\\resources\\images\\icecream.jpg";
	public static final String ImagePath3 = System.getProperty("user.dir")
			+ "\\src\\test\\resources\\images\\softtoys.jpg";
	public static final String screenshotutility_screenshot_filepath = System.getProperty("user.dir")
			+ "\\OutputScreenshots\\";
