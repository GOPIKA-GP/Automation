...
public class ManageProductPage {
	...
	@FindBy(xpath="//span[@class='badge bg-success']")WebElement productavailabilitybutton;
	@FindBy(xpath="//div[@class='alert alert-success alert-dismissible']")WebElement productavailabilityaleart;
	@FindBy(xpath="//span[@class='badge bg-danger']")WebElement productstockbutton;
