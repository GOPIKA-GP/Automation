...
public class CategoryPage {
	...
	@FindBy(xpath = "//input[@name='show_home' and @checked='checked' ]")
	WebElement showonleftmenuradiobutton;
	@FindBy(xpath = "//button[@class='btn btn-danger']")
	WebElement savebutton;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement alertcreatecategory;
	...
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	WebElement statusaleartmessage;

	@FindBy(xpath = "//a[@href='https://groceryapp.uniqassosiates.com/admin/category/edit?edit=569&page_ad=1']")
