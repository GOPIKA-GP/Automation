...
public class ManageNewsPage {
  ...
  @FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/news/add']")WebElement newcreatenewsbutton;
  ...
  @FindBy(xpath="//i[@class=' fa fa-search']")WebElement searchoption; 
  ...
  @FindBy(xpath="//td[text()='New User....!!! Get 7% Discount On Your First Purchase...']")WebElement searchalert;
  
  @FindBy(xpath="//a[@class='btn btn-sm btn btn-primary btncss' and @role='button']")WebElement editbutton;
  @FindBy(xpath="//textarea[@placeholder='Enter the news']")WebElement editnewsfield;
  @FindBy(xpath="//button[@class='btn btn-danger']")WebElement updatebutton;
  @FindBy(xpath="//td[text()='New User....!!! Get 7% Discount On Your First Purchase...']")WebElement newsfieldtoupdate;
