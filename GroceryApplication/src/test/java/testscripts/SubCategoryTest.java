...
public class SubCategoryTest extends BaseClass {
	...
	public void checkWhetherAdminCanSearchwithInvalidSubCategory() throws IOException {
		login = new LoginPage(driver);
		homepage = login.loginUsingExcelData();
		scpage = homepage.clickOnSubcategory().clickOnSubCategeorySearchButton().searchListSubCategoriesdropdown()
				.searchListSubCategoriesdropdown().enterseachSubCategoryField().clickonSeachButton();
